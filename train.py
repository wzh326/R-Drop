...
def save_model(args, model,optimizer):
    ...
    model_checkpoint = os.path.join(args.output_dir, "checkpoint.pdparams" )
    optimizer_checkpoint = os.path.join(args.output_dir, "checkpoint.pdopt" )

    fleet.save_persistables(model.state_dict(), model_checkpoint)
    fleet.save_persistables(optimizer.state_dict(), optimizer_checkpoint)
...
def main():
    ...
    parser.add_argument("--pretrained_dir", type=str, default="/home/aistudio/data/data107658/imagenet21k_ViT-B_16.npz",
